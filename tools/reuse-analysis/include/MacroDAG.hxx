/* TODO : There are two files for the same implementation;
one in reuse-analysis and other in reuse-analysis-witv.
merge them */
...
{
public:
	void generateMacroDAG(DiskCDAG<GraphNode> *cdag,
		...
		BYTE *mergedNodesBitSet, Id macroGraphSize)
	{
        ...
        GraphNode *tempNodeForFinalWrite = new GraphNode();
        ...
        // DiskCache<GraphNode, Id> *macroDagCache = new DiskCache<GraphNode, Id>(5120, 48);
